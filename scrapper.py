...
#chrome_options.add_argument("--window-size=1820,980") # site is responsive.
...
wait.until(EC.presence_of_element_located((By.XPATH, '//*[@id="search-page"]/div[2]/ul/li[1]')))  # wait till results load
